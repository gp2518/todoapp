...
async function go(){
  let client=new MongoClient('mongodb+srv://guruprasath775:gurumsd7@cluster0.kp86pov.mongodb.net/todoapp?retryWrites=true&w=majority')
...
app.get('/',async function(req,res){
  const it=await db.collection('items').find().toArray()
  console.log(it)  
